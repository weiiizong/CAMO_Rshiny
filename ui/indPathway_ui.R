  ...
  tabPanel("Individual pathway analysis", value=id,
           sidebarLayout(
             sidebarPanel(
               ...
               hr(),
               h3("(iii) Topological gene module detection for KEGG pathways"),
               ...
               radioButtons(ns("MD_KEGG.dataGisTopologyG"), "Gene nomenclature in the study matched to KEGG pathway database?", choices = list("TRUE" = "TRUE", "FALSE" = "FALSE"), selected = "FALSE"),
               ...
               bsCollapsePanel("Advanced settings for topological gene module detection",
                               ...
                               numericInput(ns("DE_PM_cut"), "Cutoff value for posterior probability of DE", 0.2, min = 0),
