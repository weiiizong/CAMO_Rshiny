             ...
             mainPanel(
               tabsetPanel(
                 ...
                 tabPanel("Visualization of pathway clusters",
                          h3("Multidimensional scaling (MDS) map of all pathways based on pathway-level c-scores colored by cluster labels"),
                          imageOutput(ns("mdsPathway"), height = 500),
                          h3("Heatmap of -log10 transformed pathway-level c-score pvalues ordered by cluster labels"),
                          imageOutput(ns("heatmapPathway"),height = 500)),
                 tabPanel("Text mining on each pathway cluster",
                          h3("Table of enriched key words & Co-membership heatmap in each cluster"),
